...
describe Joltage do
  ...
  it "should find the highest 12 digit sequence without changing the order of the digits" do
    expect(joltage.override(987654321111111)).to eq(987654321111)
  end

  it "should find the highest 12 digit sequence without changing the order" do
    expect(joltage.override(818181911112111)).to eq(888911112111)
  end
end
